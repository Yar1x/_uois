...
Updtanul se repositář, akorát máme teď všechny projekty v jednom a nepřišlo se na to jak pracovat jen s jedním.
Byla potřeba dodělat už akorát editory a upravit si feeder.
Nepovedlo se zprovoznit apollo, jelikož házelo internal server error.
